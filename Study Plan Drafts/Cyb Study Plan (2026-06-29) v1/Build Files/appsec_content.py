...
def build_content(story, S, banner, bi, nb, rule, grid_table,
    ...
    add(P("A one-page map of the plan: what each phase is for, what you study, and what you walk "
          "away with. Full schedules, resources, and concept lists follow within each phase.", S["body"]))
    add(SP(4))
    for _line in [
        "<b>0 — Pre-Study: Foundations</b> (Wks 1–3). <b>Purpose:</b> build the engineering base before security content — Python/FastAPI, HTTP, Docker, a working lab. <b>Resources:</b> FastAPI docs, MDN HTTP, OWASP WebGoat. <b>Achievement:</b> a complete FastAPI app built from scratch and a running local lab.",
        "<b>I — AppSec Intro: A Dip into Offense</b> (Wks 4–5). <b>Purpose:</b> first taste of the attacker mindset — how web vulnerabilities are found and exploited. <b>Resources:</b> “Real-World Bug Hunting” (Ch 1–5), PortSwigger Web Security Academy, TryHackMe. <b>Achievement:</b> first documented lab writeups.",
        "<b>II — Web & Network Foundations</b> (Mo 1.5–2.25). <b>Purpose:</b> deep HTTP, web, and authentication foundations plus Burp basics. <b>Resources:</b> “Alice and Bob Learn Application Security”, WAHH, Burp Suite docs, the PortSwigger Authentication path. <b>Achievement:</b> Burp fluency, HTTP/auth/session mastery, apprentice labs cleared.",
        "<b>III — Core Vulnerability Classes</b> (Mo 2.5–3.5). <b>Purpose:</b> master the core web vulnerability classes hands-on at practitioner depth. <b>Resources:</b> PortSwigger topic paths and their apprentice/practitioner labs, “Hacking APIs”, the OWASP Top 10. <b>Achievement:</b> practitioner labs across the OWASP classes and an OWASP Top 10 writeup series.",
        "<b>IV — Security Testing & Tooling</b> (Mo 3.5–5.25). <b>Purpose:</b> tooling fluency — Burp mastery, SAST, DAST, SCA — and certification. <b>Resources:</b> Burp docs, PortSwigger BSCP practice exams, Semgrep, Bandit, OWASP ZAP, Snyk. <b>Achievement:</b> passed the Burp Suite Certified Practitioner (BSCP) exam and a full Juice Shop security assessment.",
        "<b>V — Cloud Security Fundamentals</b> (Mo 5.25–5.75). <b>Purpose:</b> AWS security basics — shared responsibility, IAM, and common misconfigurations. <b>Resources:</b> flaws.cloud, flaws2.cloud, AWS IAM docs. <b>Achievement:</b> flaws.cloud and flaws2.cloud cleared with writeups.",
        "<b>VI — Secure Code Review & Threat Modeling</b> (Mo 5.75–6.5). <b>Purpose:</b> the core AppSec craft — manual secure code review and threat modeling. <b>Resources:</b> OWASP Code Review Guide, OWASP ASVS, “Threat Modeling: Designing for Security”. <b>Achievement:</b> a documented code review and a threat model in the portfolio.",
        "<b>VII — CompTIA Security+ Certification</b> (Mo 6.75–7.25). <b>Purpose:</b> earn the credential that clears HR and ATS filters; main application push. <b>Resources:</b> the “Get Certified Get Ahead: SY0-701” study guide and Professor Messer practice exams. <b>Achievement:</b> passed CompTIA Security+ (SY0-701).",
        "<b>VIII — Interview Preparation & Interviewing</b> (Mo 7.5–8). <b>Purpose:</b> convert skills and portfolio into offers — interview prep, story framing, application strategy. <b>Resources:</b> your portfolio writeups and mock interviews. <b>Achievement:</b> a polished portfolio and interview narrative, plus active interviewing.",
        "<b>IX — Expected First Days on the Job</b> (Mo 7.75+). <b>Purpose:</b> start strong in the new role and know your immediate differentiators. <b>Resources:</b> your accumulated notes and the five core reference books. <b>Achievement:</b> a clear first-30/60/90 approach and early on-the-job wins.",
    ]:
    ...
    step("01", "EXPLORE", "PortSwigger Academy Orientation \u00b7 Week 4", [
        ...
        "Read the <a href=\"https://portswigger.net/web-security/sql-injection\" color=\"#3A7AB8\">SQL "
        "injection</a> material, then complete the first 3\u20134 Apprentice & Practitioner level "
        "<a href=\"https://portswigger.net/web-security/all-labs#sql-injection\" color=\"#3A7AB8\">labs</a>",
        "Read the <a href=\"https://portswigger.net/web-security/cross-site-scripting\" color=\"#3A7AB8\">"
        "cross-site scripting</a> material, then complete the first 3\u20134 Apprentice-level "
    ...
    step("02", "READ + LABS", "Authentication & Session Management \u00b7 Weeks 6\u20137", [
        ...
        "Read <a href=\"https://portswigger.net/web-security/jwt\" color=\"#3A7AB8\">JWT algorithm confusion</a> and "
        "<a href=\"https://portswigger.net/web-security/oauth\" color=\"#3A7AB8\">OAuth redirect URI manipulation</a>",
    ...
    step("01", "READ + LABS: Injection Classes", "Weeks 10–11", [
        "Re-read the PortSwigger <a href=\"https://portswigger.net/web-security/sql-injection\" color=\"#3A7AB8\">SQL injection</a> learning path and your Phase II notes, then complete the "
        "practitioner <a href=\"https://portswigger.net/web-security/all-labs#sql-injection\" color=\"#3A7AB8\">labs</a> \u2014 the UNION-based and blind (boolean- and time-based) techniques; skip the out-of-band labs (they need Burp Collaborator and are pentest-niche)",
        "Work through the PortSwigger <a href=\"https://portswigger.net/web-security/os-command-injection\" color=\"#3A7AB8\">OS command injection</a> and <a href=\"https://portswigger.net/web-security/server-side-template-injection\" color=\"#3A7AB8\">Server-side template injection</a> learning paths, then their labs \u2014 the OS command injection <a href=\"https://portswigger.net/web-security/all-labs#os-command-injection\" color=\"#3A7AB8\">labs</a> (the simple case plus blind time-delay and output-redirection; skip out-of-band exfiltration) and the basic SSTI <a href=\"https://portswigger.net/web-security/all-labs#server-side-template-injection\" color=\"#3A7AB8\">labs</a> only (enough to recognize SSTI in review; skip the engine-specific gadget exploitation)",
    ...
    step("01", "LEARN + LABS: Burp Suite Mastery", "Weeks 15\u201316", [
        ...
        "Decoder: <a href=\"https://portswigger.net/web-security/sql-injection/lab-sql-injection-with-filter-bypass-via-xml-encoding\" color=\"#3A7AB8\">SQL injection with filter bypass via XML encoding</a> (<a href=\"https://portswigger.net/web-security/all-labs#essential-skills\" color=\"#3A7AB8\">Essential skills</a>) \u2014 encode the payload as XML/HTML entities to bypass the WAF",
        "Comparer: <a href=\"https://portswigger.net/web-security/authentication/password-based/lab-username-enumeration-via-different-responses\" color=\"#3A7AB8\">Username enumeration via different responses</a> (<a href=\"https://portswigger.net/web-security/all-labs#authentication\" color=\"#3A7AB8\">Authentication</a>) \u2014 spot the one login response that differs",
        "Both: <a href=\"https://portswigger.net/web-security/sql-injection/blind/lab-conditional-responses\" color=\"#3A7AB8\">Blind SQL injection with conditional responses</a> (<a href=\"https://portswigger.net/web-security/all-labs#sql-injection\" color=\"#3A7AB8\">SQL injection</a>) \u2014 read the admin password one true/false answer at a time",
        "By end of Week 16: fluent with Decoder and Comparer, and comfortable with Proxy match-and-replace and Repeater tab groups",
    ])
    step("02", "PROJECT: Burp Suite Certified Practitioner Prep", "Weeks 15\u201317", [
        ...
        "<b>Burp Suite Professional required:</b> the exam, its practice exams, the targeted Scanner, and Burp Collaborator (for out-of-band work) all need <a href=\"https://portswigger.net/burp/pro\" color=\"#3A7AB8\">Burp Suite Professional</a> (~$499/yr) \u2014 Community Edition is not sufficient. Stay on Community through Phases I\u2013III and the early Phase IV tooling, then buy Pro now, at the start of BSCP-specific prep, when you first need Collaborator, the Scanner, and the practice exams; the exam itself is ~$99 per attempt.",
        ...
        "Gate 5 (simulation): pass the <a href=\"https://portswigger.net/web-security/certification/practice-exam\" color=\"#3A7AB8\">BSCP practice exam</a> in under 2 hours \u2014 and do it more than once \u2014 before booking the real exam. It mirrors the real format exactly, so consistently passing it under time is the strongest signal you are ready",
        "A passed BSCP on the resume is a stronger AppSec signal than Sec+ alone",
    ])
    step("03", "DOCUMENT: Save Exam-Ready PoCs", "Throughout Weeks 15\u201320", [
    ...
    step("05", "LEARN: Secrets Scanning — TruffleHog & Gitleaks", "Week 17", [
        ...
        "<a href=\"https://github.com/gitleaks/gitleaks\" color=\"#3A7AB8\">Gitleaks</a>: install and run as a CI pre-commit hook. Lightweight and fast, well-suited for "
    ...
    step("07", "LABS: Out-of-Band (OOB) Exploitation with Burp Collaborator", "Weeks 17\u201318", [
        "<b>Requires Burp Suite Professional</b> \u2014 Burp Collaborator is Pro-only, and nearly every blind / out-of-band variant on the BSCP routes through it. This step closes the OOB gap left by skipping these labs in Phase III.",
        "Blind SQL injection: re-read the <a href=\"https://portswigger.net/web-security/sql-injection/blind\" color=\"#3A7AB8\">blind SQL injection</a> learning path, then the out-of-band <a href=\"https://portswigger.net/web-security/all-labs#sql-injection\" color=\"#3A7AB8\">labs</a> \u2014 <i>Blind SQL injection with out-of-band interaction</i> and <i>Blind SQL injection with out-of-band data exfiltration</i> (practitioner)",
        "Blind XXE: re-read the <a href=\"https://portswigger.net/web-security/xxe/blind\" color=\"#3A7AB8\">blind XXE</a> learning path, then the out-of-band <a href=\"https://portswigger.net/web-security/all-labs#xml-external-entity-xxe-injection\" color=\"#3A7AB8\">labs</a> \u2014 <i>Blind XXE with out-of-band interaction</i> and <i>Exploiting blind XXE to exfiltrate data using a malicious external DTD</i>",
        "Blind OS command injection: from the <a href=\"https://portswigger.net/web-security/os-command-injection\" color=\"#3A7AB8\">OS command injection</a> learning path, the out-of-band <a href=\"https://portswigger.net/web-security/all-labs#os-command-injection\" color=\"#3A7AB8\">labs</a> \u2014 <i>Blind OS command injection with out-of-band interaction</i> and <i>... with out-of-band data exfiltration</i>",
    ...
    step("08", "READ + LABS: Remaining BSCP Topics", "Weeks 17\u201319", [
        ...
        "<a href=\"https://portswigger.net/web-security/oauth\" color=\"#3A7AB8\">OAuth authentication</a> learning path, then the <a href=\"https://portswigger.net/web-security/all-labs#oauth-authentication\" color=\"#3A7AB8\">labs</a> \u2014 <i>Authentication bypass via OAuth implicit flow</i>, <i>Forced OAuth profile linking</i>, and <i>OAuth account hijacking via redirect_uri</i>",
        "<a href=\"https://portswigger.net/web-security/jwt\" color=\"#3A7AB8\">JWT</a> learning path, then the <a href=\"https://portswigger.net/web-security/all-labs#jwt\" color=\"#3A7AB8\">labs</a> \u2014 <i>bypass via unverified signature</i>, <i>via flawed signature verification</i>, <i>via weak signing key</i>, and <i>via jwk / jku header injection</i>",
        "These five topics add roughly 2\u20133 weeks of study \u2014 budget for it before the exam",
    ])
    step("09", "LEARN + LABS: Targeted Scanning & Content Discovery", "Weeks 18\u201319", [
        ...
        "Content discovery: use Burp\u2019s Engagement tools \u2192 <i>Discover content</i> to enumerate hidden directories, files, and parameters (for example a hidden /admin) \u2014 a recurring first move on exam apps. Practice it on labs you have already solved.",
    ...
    step("10", "DRILL: PortSwigger\u2019s Mandatory Reinforcement Labs", "Weeks 19\u201320", [
        ...
        "XSS: <i>Exploiting cross-site scripting to steal cookies</i> \u2014 from <a href=\"https://portswigger.net/web-security/cross-site-scripting\" color=\"#3A7AB8\">Cross-site scripting</a>, the <a href=\"https://portswigger.net/web-security/all-labs#cross-site-scripting\" color=\"#3A7AB8\">labs</a>; exfiltrate a real session cookie (not just an alert()), which is what the exam rewards (reinforces step 03)",
        "Authentication: <i>Brute-forcing a stay-logged-in cookie</i> \u2014 from <a href=\"https://portswigger.net/web-security/authentication\" color=\"#3A7AB8\">Authentication</a>, the <a href=\"https://portswigger.net/web-security/all-labs#authentication\" color=\"#3A7AB8\">labs</a>; decode the cookie in Decoder, then brute-force it with Intruder",
        "SSRF: <i>SSRF with blacklist-based input filter</i> \u2014 from <a href=\"https://portswigger.net/web-security/ssrf\" color=\"#3A7AB8\">SSRF</a>, the <a href=\"https://portswigger.net/web-security/all-labs#server-side-request-forgery-ssrf\" color=\"#3A7AB8\">labs</a>; the filter-bypass variant skipped in Phase III",
        "Already done elsewhere \u2014 re-confirm you can solve each cold: <i>Forced OAuth profile linking</i> (step 08), <i>Exploiting HTTP request smuggling to capture other users\u2019 requests</i> (step 08), <i>Blind SQL injection with out-of-band data exfiltration</i> (step 07), <i>SQL injection with filter bypass via XML encoding</i> (step 01), and <i>Discovering vulnerabilities quickly with targeted scanning</i> (step 09)",
    ...
    step("11", "DRILL: Fluency \u2014 Re-Solve Cold", "Week 20", [
        "Gate 2 (fluency): for each major class, take one practitioner lab you have already solved and re-solve it cold \u2014 no notes, no solution \u2014 in 15 minutes or less.",
    ...
    step("13", "DRILL: Exam Stamina \u2014 Six Labs in One Block", "Week 20", [
        "Gate 4 (stamina): the real exam is a single continuous 4-hour session \u2014 two applications, three stages each, six flags, no partial credit. Rehearse that endurance before you book it.",
    ...
    step("15", "APPLY: Begin Job Applications", "Month 4 onward", [
        ...
        "Applications run in parallel with the remaining phases and ramp into a main push around "
        "Month 7, once Security+ is on your resume",
        "See \u201cApplication Strategy\u201d in Phase VIII for the full targeting, profile, and "
        "framing playbook",
    ])
    step("16", "LEARN: Snyk — Dependency Scanning", "Week 21", [
        "Run <a href=\"https://snyk.io/\" color=\"#3A7AB8\">Snyk</a> against a sample Python project with known-vulnerable dependencies",
    ...
    # ════════════════════════════════════════════════════════════════════════
    add(PageBreak())
    add(P("\u00a0", S["body"]))   # forced blank page: bump VI to start one page later
    add(PageBreak())
    ...
    step("02", "STUDY: OWASP ASVS — Verification Standard", "Week 25", [
        "Read <a href=\"https://owasp.org/www-project-application-security-verification-standard/\" color=\"#3A7AB8\">ASVS</a> v4.0 Level 1 and Level 2 requirements. Do not try to memorize — learn the "
    ...
    step("04", "PRACTICE: Code Review Under Time Pressure", "Week 26", [
        ...
        "Use <a href=\"https://securitylab.github.com/\" color=\"#3A7AB8\">GitHub Security Lab</a>’s published CVE writeups as answer keys: read the vulnerable code "
    ...
    step("04", "APPLY: Main Application Push", "Week 29 onward", [
        ...
        "Continue through interview preparation (Phase VIII); see \u201cApplication Strategy\u201d "
