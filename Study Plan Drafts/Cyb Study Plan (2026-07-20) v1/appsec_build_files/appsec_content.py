...
def build_content(story, S, banner, bi, nb, rule, grid_table,
    ...
    add(P("AppSec interviews test security knowledge \u2014 OWASP concepts, secure code review, "
          ...
          "what is wrong with it \u2014 something five years of building full-stack code makes "
          "you structurally prepared for. The relief this brings is real and substantial: a break "
          "from never-ending LeetCode grinding, contrived software-engineering interviews, and the "
          "poor communication that runs through the whole software-engineering interview process.", S["body"]))
    add(SP(2))
    ...
    add(P("This plan is calibrated for 7\u20139 months at 21 study hours per week. 7 "
          "months is the optimistic case; 9 months is the outer bound; 8 months is the realistic "
    ...
    names = ["Pre-\nStudy","AppSec\nIntro","Web &\nNetwork","Core\nVulns","Testing &\nTooling",
             "Cloud\nSecurity","Code\nReview","Sec+\nCert","Interview\nPrep","First\nDays"]
    weeks = ["Wks 1\u20133","Wks 4\u20135","Mo 1.25\u20132.25","Mo 2.25\u20134.0","Mo 4.0\u20136.25",
             "Mo 6.25\u20136.75","Mo 6.75\u20137.5","Mo 7.5\u20138.5","Mo 8.5\u20139.25","Mo 9.25+"]
    ...
    add(tt)
    add(SP(8))
    add(nb("<b>Timeline:</b> 7 months is the optimistic case; 9 months is the outer bound; 8 "
           ...
           "roles. Security+ lands on your resume at Month 8.5, strengthening the main application "
    ...
    add(B("<b>Suggested usage:</b> One session upfront to review this plan. Monthly check-ins at "
          "phase transitions. Regular mock interviews (code review and behavioral) from mid-plan "
          "onward \u2014 running well before your first real interview. Async questions for anything "
          "that blocks progress."))
    add(B("<b>Cost:</b> $100\u2013$150/month. 7-day trial lets you test fit. Highest-ROI "
          "expenditure in the plan."))
    add(B("<b>When to start:</b> Before Phase I \u2014 and make the very first session a hard review "
          "of this plan itself: is it a realistic route into an entry-level AppSec role, and what "
          "should change? Ask for concrete edits \u2014 what to add, cut, or update."))
    add(SP(2))
    ...
    for _line in [
        ...
        "<b>Phase I — AppSec Intro: A Dip into Offense</b> (Wks 4–5). <b>Purpose:</b> first taste of the attacker mindset — how web vulnerabilities are found and exploited. <b>Resources:</b> <i>Real-World Bug Hunting</i> (Ch 1–5), PortSwigger Web Security Academy, TryHackMe, OWASP WebGoat. <b>Achievement:</b> first labs and published lab writeups.",
        "<b>Phase II — Web & Network Foundations</b> (Mo 1.25–2.25). <b>Purpose:</b> deep HTTP, web, and authentication foundations plus Burp basics. <b>Resources:</b> <i>Alice and Bob Learn Application Security</i>, <i>WAHH</i>, Burp Suite docs, PortSwigger Authentication path. <b>Achievement:</b> Burp fluency, HTTP/auth/session mastery, and the PortSwigger Authentication, JWT, and OAuth labs cleared.",
        "<b>Phase III — Core Vulnerability Classes</b> (Mo 2.25–4.0). <b>Purpose:</b> master the core web vulnerability classes hands-on at practitioner depth. <b>Resources:</b> PortSwigger topic paths and their apprentice/practitioner labs, <i>Hacking APIs</i>, the OWASP Top 10, and the OWASP Top 10 for LLM Applications. <b>Achievement:</b> practitioner labs across the OWASP classes and the OWASP LLM Top 10, plus an OWASP Top 10 writeup series.",
        "<b>Phase IV — Security Testing & Tooling</b> (Mo 4.0–6.25). <b>Purpose:</b> tooling fluency — Burp mastery, SAST, DAST, SCA, and secrets scanning — and the BSCP certification. <b>Resources:</b> Burp docs, PortSwigger BSCP practice exams, Semgrep, Bandit, OWASP ZAP, Snyk, TruffleHog, Gitleaks. <b>Achievement:</b> passed the Burp Suite Certified Practitioner (BSCP) exam, completed a full Juice Shop security assessment, and secured a small LLM-backed API.",
        "<b>Phase V — Cloud Security Fundamentals</b> (Mo 6.25–6.75). <b>Purpose:</b> AWS security basics — shared responsibility, IAM, and common misconfigurations. <b>Resources:</b> flaws&#46;cloud, flaws2&#46;cloud, AWS IAM docs. <b>Achievement:</b> every level of the flaws&#46;cloud and flaws2&#46;cloud AWS security challenges completed, with writeups.",
        "<b>Phase VI — Secure Code Review & Threat Modeling</b> (Mo 6.75–7.5). <b>Purpose:</b> the core AppSec craft — manual secure code review and threat modeling. <b>Resources:</b> OWASP Code Review Guide, OWASP ASVS, <i>Threat Modeling: Designing for Security</i>. <b>Achievement:</b> a documented code review and a threat model project.",
        "<b>Phase VII — CompTIA Security+ Certification</b> (Mo 7.5–8.5). <b>Purpose:</b> earn the credential that clears HR and ATS filters; main application push. <b>Resources:</b> the <i>Get Certified Get Ahead: SY0-701</i> study guide and Professor Messer practice exams. <b>Achievement:</b> passed CompTIA Security+ (SY0-701).",
        "<b>Phase VIII — Interview Preparation & Interviewing</b> (Mo 8.5–9.25). <b>Purpose:</b> convert skills and portfolio into offers — interview prep, story framing, application strategy. <b>Resources:</b> <i>Impractical Python Projects</i>, a cybersecurity interview question bank, GitHub Security Lab, and mock interview platforms. <b>Achievement:</b> a polished portfolio and interview narrative, plus active interviewing.",
        "<b>Phase IX — Expected First Days on the Job</b> (Mo 9.25+). <b>Purpose:</b> start strong in the new sub-field and role and know your immediate differentiators. <b>Resources:</b> your accumulated notes and the five core reference books. <b>Achievement:</b> a first-two-weeks plan, a clear grasp of your immediate differentiators, and early on-the-job wins.",
    ]:
    ...
    step("04", "LEARN + PRACTICE", "Docker \u00b7 Days 2\u20134", [
        ...
        "a container, map a port, list with docker ps, then stop and remove it.",
    ...
    # ════════════════════════════════════════════════════════════════════════
    add(PageBreak())
    add(banner("II", "Web & Network Foundations", "Months 1.25\u20132.25"))
    add(SP(10))
    ...
    add(SP(4))
    SS("Web & Network Foundations \u2014 Months 1.25\u20132.25")
    ...
    concept("Networking as an attack surface",
            "DNS rebinding exploits the gap between DNS validation and the TCP connection, "
            "bypassing SSRF protections. SSRF against private IP ranges and the AWS metadata "
            "endpoint (169.254.169.254) is the most common high-severity cloud vulnerability. "
            "Where TLS terminates in an architecture tells you whether internal traffic is "
            "encrypted; HTTP statelessness is why cookies exist and therefore an attack surface; "
            "and unexpected open ports in a deployment configuration are a finding. These are the "
            "specific networking behaviors AppSec engineers encounter in real work, not "
            "networking-engineering concepts.")
    ...
    # ════════════════════════════════════════════════════════════════════════
    add(PageBreak())
    add(banner("III", "Core Vulnerability Classes", "Months 2.25–4.0"))
    add(SP(10))
    ...
    add(SP(4))
    SS("Core Vulnerability Classes — Months 2.25–4.0")
    ...
    step("08", "READ + LABS: Web LLM Attacks (PortSwigger)", "Weeks 15\u201316", [
        ...
        "<a href=\"https://portswigger.net/web-security/llm-attacks\" color=\"#3A7AB8\">Web LLM attacks</a> learning path, then the <a href=\"https://portswigger.net/web-security/all-labs#web-llm-attacks\" color=\"#3A7AB8\">labs</a> \u2014 Exploiting LLM APIs with excessive agency, Exploiting vulnerabilities in LLM APIs, Indirect prompt injection, and the AI-powered scanner labs",
    ])
    step("09", "READ: OWASP Top 10 for LLM Applications", "Week 16", [
    ...
    concept("Securing LLM-backed features",
            "An increasingly common AppSec task. The LLM-specific classes \u2014 prompt injection, "
            "insecure output handling, excessive agency, and sensitive information disclosure \u2014 sit "
            "on top of the classic vulnerabilities you already review, and map onto skills you have: "
            "injection is injection, output handling is untrusted-input handling, excessive agency is "
            "least privilege.")
    ...
    # ════════════════════════════════════════════════════════════════════════
    add(PageBreak())
    add(banner("IV", "Security Testing & Tooling", "Months 4.0–6.25"))
    add(SP(10))
    ...
    add(SP(4))
    add(PageBreak())
    SS("Security Testing & Tooling — Months 4.0–6.25")
    step("01", "LEARN + LABS: Burp Suite Mastery", "Weeks 17\u201318", [
        ...
        "<b>By end of Week 18:</b> fluent with Decoder and Comparer, and comfortable with Proxy match-and-replace and Repeater tab groups",
    ])
    step("02", "PROJECT: Burp Suite Certified Practitioner Prep", "Weeks 17\u201319", [
    ...
    step("03", "DOCUMENT: Save Exam-Ready Proof-of-Concept Exploits", "Throughout Weeks 17\u201324", [
    ...
    step("04", "LEARN + LABS: Semgrep & Bandit — SAST Tooling", "Weeks 18\u201319", [
        ...
        "<a name=\"art_semgrep\"/><a href=\"https://semgrep.dev/docs/writing-rules/overview\" color=\"#3A7AB8\">Write one custom Semgrep rule</a> targeting a Python injection pattern — for example, an "
    ...
    step("05", "LEARN: Secrets Scanning — TruffleHog & Gitleaks", "Week 19", [
    ...
    step("06", "LEARN: OWASP ZAP — DAST Basics", "Week 19", [
    ...
    step("07", "LABS: Out-of-Band (OOB) Exploitation with Burp Collaborator", "Weeks 19\u201320", [
    ...
    step("08", "READ + LABS: Remaining BSCP Topics", "Weeks 19\u201321", [
    ...
    step("09", "LEARN + LABS: Targeted Scanning & Content Discovery", "Weeks 20\u201321", [
    ...
    step("10", "DRILL: PortSwigger\u2019s Mandatory Reinforcement Labs", "Weeks 22\u201323", [
    ...
    step("11", "DRILL: Fluency \u2014 Re-Solve Cold", "Week 23", [
    ...
    step("12", "DRILL: Mystery Labs \u2014 Cold Recognition", "Weeks 23\u201324", [
    ...
    step("13", "DRILL: Exam Stamina \u2014 Six Labs in One Block", "Week 24", [
    ...
    step("14", "EXAM: Burp Suite Certified Practitioner", "Weeks 24\u201325", [
    ...
    step("17", "PROJECT: Full Security Assessment of Juice Shop", "Week 25", [
        "<a name=\"art_juiceshop\"/>Conduct a full security assessment of <a href=\"https://owasp.org/www-project-juice-shop/\" color=\"#3A7AB8\">OWASP Juice Shop</a> using: Burp Suite (manual), ZAP "
    ...
    step("18", "PROJECT: Secure a Small LLM-Backed API", "Week 25", [
        ...
        "support-reply route that calls a hosted model API (for example the <a href=\"https://docs.anthropic.com/en/docs/get-started\" color=\"#3A7AB8\">Anthropic</a> or OpenAI "
    ...
    # ════════════════════════════════════════════════════════════════════════
    add(PageBreak())
    add(banner("V", "Cloud Security Fundamentals", "Months 6.25–6.75"))
    add(SP(10))
    ...
    add(SP(4))
    SS("Cloud Security Fundamentals — Months 6.25–6.75")
    step("01", "READ: AWS Foundations: Shared Responsibility & IAM", "Week 26", [
    ...
    add(PageBreak())
    step("02", "LABS: flaws.cloud — Levels 1–6", "Week 26–27", [
    ...
    step("03", "LABS: flaws2.cloud — Attacker & Defender Paths", "Week 27", [
    ...
    concept("S3 bucket misconfiguration",
            ...
            "contents. Authenticated AWS user access means any AWS account holder worldwide can read "
    ...
    # ════════════════════════════════════════════════════════════════════════
    add(PageBreak())
    add(banner("VI", "Secure Code Review & Threat Modeling", "Months 6.75–7.5"))
    add(SP(10))
    ...
    add(SP(4))
    SS("Secure Code Review & Threat Modeling — Months 6.75–7.5")
    step("01", "READ + PRACTICE: Secure Code Review Methodology", "Weeks 28–29", [
    ...
    step("02", "STUDY: OWASP ASVS — Verification Standard", "Week 29", [
    ...
    step("03", "READ + PROJECT: Threat Modeling", "Weeks 29–30", [
        "<a name=\"art_threatmodel\"/>Read “<i>Threat Modeling: Designing for Security</i>” Ch. 1–5",
    ...
    step("04", "PRACTICE: Code Review Under Time Pressure", "Week 30", [
    ...
    add(P("Full STRIDE threat model of a real-world system architecture. DFD, trust boundaries, "
          ...
          "artifact — most AppSec candidates have lab writeups but not threat models. A strong target is an LLM-integrated agent that calls tools, forcing STRIDE to cover excessive agency and prompt injection too.", S["bulsm"]))
    ...
    # ════════════════════════════════════════════════════════════════════════
    add(PageBreak())
    add(banner("VII", "CompTIA Security+ Certification", "Months 7.5–8.5"))
    add(SP(10))
    add(P("CompTIA Security+ is best understood as a resume-screen credential. It is required or preferred "
    ...
    res("“<i>CompTIA Security+ Get Certified Get Ahead: SY0-701 Study Guide</i>”", "Joe Shelley and Darril "
        "Gibson, Certification Experts LLC, 2023 (getcertifiedgetahead.com) — 674 pages "
    ...
    add(SP(4))
    SS("CompTIA Security+ Certification — Months 7.5–8.5")
    step("01", "READ + MEMORIZE: Study Guide", "Weeks 31–33", [
        "Read “<i>CompTIA Security+ Get Certified Get Ahead: SY0-701 Study Guide</i>” cover to cover. The "
    ...
    step("02", "PRACTICE: Practice Exams", "Weeks 33–34", [
    ...
    add(PageBreak())
    step("03", "EXAM: CompTIA Security+ SY0-701", "Week 34", [
        "<b>Delivery:</b> schedule through Pearson VUE and take it in person at a <a href=\"https://wsr.pearsonvue.com/testtaker/find/testcenter/COMPTIA?locale=en_US\" color=\"#3A7AB8\">Center City Philadelphia test center</a> \u2014 about $404 (2026), valid for three years",
        ...
        "<b>Retakes:</b> unlimited \u2014 no wait for the first retake, then a 14-day wait after any further fail, full price each; once you pass you cannot retake the same code for 12 months",
    ])
    step("04", "APPLY: Main Application Push", "Week 34 onward", [
        ...
        "<b>Daily target:</b> 2\u20134 applications a day, each with a resume and cover letter tailored to the specific role \u2014 budget roughly 1\u20132 hours per application for that personalization",
    ...
    add(PageBreak())
    add(banner("VIII", "Interview Preparation & Interviewing", "Months 8.5–9.25"))
    add(SP(10))
    add(P("AppSec interviews test security knowledge, adversarial reasoning, and communication rather than algorithmic problem solving. This phase runs interview preparation alongside the ongoing job search: rehearsing behavioral answers, drilling technical note cards, practicing the live technical formats \u2014 secure code review, light scripting, and system design \u2014 and running mock interviews so that the watched, timed setting is familiar before the first real interview.", S["body"]))
    add(SP(2))
    SS("Learning Resources")
    ...
    res("GitHub Security Lab", "securitylab.github.com \u2014 vulnerability research and published CVE write-ups (securitylab.github.com/advisories) used as source material for secure code review practice")
    ...
    res("Mock interview platforms", "mentorcruise.com (AppSec mentor interviews), tryexponent.com (Exponent\u2019s security engineering courses), and interviewing.io (behavioral and observed coding practice)")
    add(SP(2))
    SS("Interview Preparation & Interviewing \u2014 Months 8.5\u20139.25")
    step("01", "REHEARSE: Behavioral Questions", "Weeks 35\u201337", [
    ...
    step("02", "MEMORIZE: Technical Note Cards", "Weeks 35\u201337", [
        ...
        "Alongside cards drawn from your own study, create a deck from a reputable existing set of cybersecurity interview questions at <a href=\"https://github.com/jassics/security-interview-questions\" color=\"#3A7AB8\">github.com/jassics/security-interview-questions</a>, rewriting the answers in your own words.",
        "Study the cards by topic in sub-groups of seven, 3\u20135 passes each until they are memorized, then combine each group into a running reviewed pile and review the whole pile again; re-review anything missed further, and periodically re-read the reviewed topics to keep them fixed in memory.",
    ])
    step("03", "PRACTICE: Secure Code Review", "Weeks 35\u201337", [
    ...
    step("04", "PRACTICE: Light Scripting & System Design", "Weeks 35\u201337", [
    ...
    step("05", "PRACTICE: Mock Interviews", "Weeks 35\u201337", [
        "Run at least one full mock interview each week, covering behavioral questions and a code review, through <a href=\"https://mentorcruise.com/\" color=\"#3A7AB8\">MentorCruise</a> (AppSec mentors), <a href=\"https://www.tryexponent.com/courses?query=security%20engineering\" color=\"#3A7AB8\">Exponent</a> (its security engineering courses), or <a href=\"https://interviewing.io/\" color=\"#3A7AB8\">interviewing.io</a>, so that a real interview is never the first time you perform under observation.",
    ...
    add(B("<b>Start applying at Month 4:</b> security-conscious startups are viable targets from Month 4 with Phases I\u2013III complete, the BSCP certification acquired, and two published write-ups and PortSwigger Academy progress visible. Do not wait for curriculum completion."))
    ...
    add(B("<b>Make LinkedIn application-ready:</b> list Security+ and, once passed, BSCP under licenses and certifications; link your portfolio projects and published write-ups; and carry the application-security transition narrative in the About section. Publish as you work through the plan, so you have work to show off during local cyber security community meetups."))
    add(B("<b>Frame the transition:</b> in cover letters and interviews, lead with the narrative \u2014 five years of full-stack software engineering, then a deliberate move into application security in June 2026 \u2014 and the pitch: \u2018I spent five years building the systems application security engineers defend, so I understand why developers write vulnerable code, because I wrote it too.\u2019 Point to this plan and portfolio as the evidence."))

    # ════════════════════════════════════════════════════════════════════════
    #  PHASE IX — EXPECTED FIRST DAYS ON THE JOB
    # ════════════════════════════════════════════════════════════════════════
    add(PageBreak())
    add(banner("IX", "Expected First Days on the Job", "Months 9.25+"))
    add(SP(10))
    add(P("You will know the vulnerability classes better than many colleagues who arrived through "
          ...
          "varying security maturity. That gap closes in weeks, not months. The self-taught web dev engineering "
          "history is the relevant benchmark: hired at 14 weeks of web dev self-study, productive "
          "within the first initial weeks of employment.", S["body"]))
    add(SP(2))
    SS("First Two Weeks")
    ...
    grp = [
        ...
        ("Ex Machina Parlor", "exmachinaparlor.org \u00b7 319 N 11th St, Room 501 \u00b7 Philadelphia",
    ...
    add(B("<b>OWASP BASC \u2014 Boston</b> (owasp.org \u00b7 Annual \u00b7 Fall) \u2014 The OWASP "
          ...
          "engineering and secure development. Lower-cost than the DC Global AppSec. "
    ...
    add(B("<b>JawnCon \u2014 Philadelphia</b> (jawncon.org \u00b7 Annual) \u2014 "
          ...
          "OWASP and DC215."))
    add(B("<b>DEF CON \u2014 Las Vegas</b> (defcon.org \u00b7 Annual \u00b7 August) \u2014 the flagship "
          "hacker conference. Within it, the AppSec Village (appsecvillage.com) is a 100% volunteer-run "
          "space specifically for application security \u2014 attacker-minded talks, live demos, hands-on "
          "workshops, a Fix-the-Flag CTF that rewards remediating vulnerabilities, and rapid tool demos at "
          "the Arsenal, the most directly relevant part of DEF CON for this career path. A larger, costlier "
