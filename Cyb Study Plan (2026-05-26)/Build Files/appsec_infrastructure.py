...
OUTPUT = "/mnt/user-data/outputs/Study_Plan_-_2026-05-26.pdf"
...
class Cover:
    def draw(self, canvas, doc):
        ...
        canvas.drawString(tx, 364.3, "Independent Self-Study \u2014 Kyle Miskell")

        # arrow progression text (two lines, DejaVu for arrow glyphs, 9.5pt)
        canvas.setFont("DejaVu", 9.5); canvas.setFillColor(colors.HexColor("#AABBDD"))
        canvas.drawString(tx, 349.0,
            "Orientation \u2192 Web Foundations \u2192 Core Vulnerabilities \u2192 Testing & Tooling \u2192 Cloud Security")
        canvas.drawString(tx, 336.0,
