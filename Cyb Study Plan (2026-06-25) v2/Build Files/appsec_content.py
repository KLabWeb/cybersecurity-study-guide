...
def build_content(story, S, banner, bi, nb, rule, grid_table,
    ...
    names = ["Pre-\nStudy","AppSec\nIntro","Web &\nNetwork","Core\nVulns","Testing &\nTooling",
             "Cloud\nSecurity","Code\nReview","Sec+\nCert","Interview\nPrep","First\nDays"]
    weeks = ["Wks 1\u20133","Wks 4\u20135","Mo 1.5\u20132.25","Mo 2.5\u20133.5","Mo 3.5\u20134.5",
    ...
    add(nb("<b>Timeline:</b> 5 months is the optimistic case; 7 months is the outer bound; 6 "
           ...
           "roles. Security+ lands on your resume at Month 6, strengthening the main application "
    ...
    step("01", "EXPLORE", "PortSwigger Academy Orientation \u00b7 Week 4", [
        ...
        "injection</a> material, then complete the first 3\u20134 Apprentice-level "
    ...
    step("01", "READ + LABS", "HTTP Deep Dive \u00b7 Week 6", [
        "Read <i>WAHH</i> Ch. 1\u20133 (web application security, core protocols, web application "
        "technologies) as foundational context",
        "Work through the <a href=\"https://portswigger.net/burp/documentation\" color=\"#3A7AB8\">official Burp Suite documentation</a> "
        "(Proxy, Repeater, Intruder) \u2014 the primary tool you will use throughout this phase",
    ...
    step("04", "READ + LABS", "Access Control & APIs \u00b7 Week 7", [
        ...
        "Complete the PortSwigger <a href=\"https://portswigger.net/web-security/access-control\" color=\"#3A7AB8\">Access control</a> and <a href=\"https://portswigger.net/web-security/api-testing\" color=\"#3A7AB8\">API testing</a> learning paths",
    ...
    step("05", "READ + LABS", "Input Handling Fundamentals \u00b7 Weeks 7\u20138", [
        "Complete the PortSwigger <a href=\"https://portswigger.net/web-security/sql-injection\" color=\"#3A7AB8\">SQL injection</a> learning path completely (apprentice "
        "through expert)",
    ...
    step("06", "READ", "“<i>Alice and Bob Learn Application Security</i>” \u00b7 Week 8", [
        "Read “<i>Alice and Bob Learn Application Security</i>” Ch. 1\u20135: security requirements, secure "
    ...
    step("01", "LABS: Injection Classes", "Weeks 10–11", [
        "Complete the PortSwigger <a href=\"https://portswigger.net/web-security/sql-injection\" color=\"#3A7AB8\">SQL injection</a> learning path (all apprentice and practitioner labs)",
        "Work through the <a href=\"https://portswigger.net/web-security/os-command-injection\" color=\"#3A7AB8\">OS command injection</a> and <a href=\"https://portswigger.net/web-security/server-side-template-injection\" color=\"#3A7AB8\">Server-side template injection</a> learning paths",
    ...
    step("03", "LABS: Cross-Site Scripting", "Week 11", [
        "Complete the PortSwigger <a href=\"https://portswigger.net/web-security/cross-site-scripting\" color=\"#3A7AB8\">Cross-site scripting</a> learning path: reflected, stored, and DOM XSS as distinct "
        "categories",
    ...
    step("04", "LABS: CSRF, SSRF, XXE", "Weeks 11–12", [
        "Complete the PortSwigger <a href=\"https://portswigger.net/web-security/csrf\" color=\"#3A7AB8\">CSRF</a>, <a href=\"https://portswigger.net/web-security/ssrf\" color=\"#3A7AB8\">SSRF</a>, and <a href=\"https://portswigger.net/web-security/xxe\" color=\"#3A7AB8\">XXE</a> learning paths",
    ...
    step("05", "LABS: Access Control & Business Logic", "Week 12", [
        "Complete the PortSwigger <a href=\"https://portswigger.net/web-security/access-control\" color=\"#3A7AB8\">Access control</a> learning path in full",
        "Work through the <a href=\"https://portswigger.net/web-security/logic-flaws\" color=\"#3A7AB8\">Business logic vulnerabilities</a> learning path",
    ...
    step("06", "LABS: Deserialization, File Upload, Path Traversal", "Week 13", [
        "Complete the PortSwigger <a href=\"https://portswigger.net/web-security/deserialization\" color=\"#3A7AB8\">Insecure deserialization</a>, <a href=\"https://portswigger.net/web-security/file-upload\" color=\"#3A7AB8\">File upload</a>, and <a href=\"https://portswigger.net/web-security/file-path-traversal\" color=\"#3A7AB8\">Path traversal</a> labs",
    ...
    step("07", "READ + LABS: API Security Deep Dive", "Weeks 13–14", [
        ...
        "Exposure",
        "Read “<i>Hacking APIs</i>” Ch. 1–3 (API reconnaissance, endpoint discovery, authentication "
        "testing) and Ch. 6–9",
        "Complete the PortSwigger <a href=\"https://portswigger.net/web-security/api-testing\" color=\"#3A7AB8\">API testing</a> learning path",
    ...
    step("01", "LEARN + LABS: Burp Suite Mastery", "Weeks 15–16", [
        "Install <a href=\"https://portswigger.net/burp/communitydownload\" color=\"#3A7AB8\">Burp Suite Community Edition</a>. Work through the official documentation: Proxy, "
        "Repeater, Intruder, Decoder, Comparer",
        "Work through the <a href=\"https://portswigger.net/burp/documentation\" color=\"#3A7AB8\">official Burp Suite documentation</a> hands-on, using it to solve Web Security Academy labs",
    ...
    step("02", "PROJECT: Burp Suite Certified Practitioner Prep", "Weeks 15–17", [
        "PortSwigger offers the <a href=\"https://portswigger.net/web-security/certification\" color=\"#3A7AB8\">BSCP exam</a> — free to take, highly respected in the AppSec "
        ...
        "Complete all <a href=\"https://portswigger.net/web-security/certification/practice-exam\" color=\"#3A7AB8\">BSCP practice exams</a> in the PortSwigger Academy",
        "A passed BSCP on the resume is a stronger AppSec signal than Sec+ alone",
    ])
    step("03", "LEARN + LABS: Semgrep & Bandit — SAST Tooling", "Week 16–17", [
        "Install the <a href=\"https://semgrep.dev/\" color=\"#3A7AB8\">Semgrep</a> CLI. Run the default Python ruleset against a sample Python application "
        ...
        "<a href=\"https://github.com/PyCQA/bandit\" color=\"#3A7AB8\">Bandit</a>: install with pip install bandit. Run against a sample Python project and against "
    ...
    step("04", "APPLY: Begin Job Applications", "Throughout Weeks 16\u201318", [
        ...
        "Month 6, once Security+ is on your resume",
    ...
    step("07", "EXAM: Burp Suite Certified Practitioner", "Week 17–18", [
    ...
    step("08", "LEARN: Snyk — Dependency Scanning", "Week 17–18", [
    ...
    step("09", "PROJECT: Full Security Assessment of Juice Shop", "Week 18", [
    ...
    step("04", "APPLY: Main Application Push", "Week 26 onward", [
