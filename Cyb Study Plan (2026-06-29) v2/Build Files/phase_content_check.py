...
VERIFIED = {
    ...
    # --- Phase III (topics from all-topics; lab anchors verified live on all-labs page) ---
    "web-security/cross-site-scripting": ("PASS", "XSS topic + labs"),
    "web-security/csrf": ("PASS", "CSRF topic"),
    "web-security/ssrf": ("PASS", "SSRF topic"),
    "web-security/xxe": ("PASS", "XXE topic"),
    "web-security/os-command-injection": ("PASS", "OS command injection topic"),
    "web-security/server-side-template-injection": ("PASS", "SSTI topic"),
    "web-security/file-path-traversal": ("PASS", "path traversal topic"),
    "web-security/deserialization": ("PASS", "insecure deserialization topic"),
    "web-security/file-upload": ("PASS", "file upload topic"),
    "web-security/logic-flaws": ("PASS", "business logic topic"),
    "all-labs#cross-site-scripting": ("PASS", "XSS labs"),
    "all-labs#cross-site-request-forgery-csrf": ("PASS", "CSRF labs"),
    "all-labs#server-side-request-forgery-ssrf": ("PASS", "SSRF labs"),
    "all-labs#xml-external-entity-xxe-injection": ("PASS", "XXE labs"),
    "all-labs#os-command-injection": ("PASS", "OS command injection labs"),
    "all-labs#server-side-template-injection": ("PASS", "SSTI labs"),
    "all-labs#path-traversal": ("PASS", "path traversal labs"),
    "all-labs#business-logic-vulnerabilities": ("PASS", "business logic labs"),
    "all-labs#insecure-deserialization": ("PASS", "deserialization labs"),
    "all-labs#file-upload-vulnerabilities": ("PASS", "file upload labs"),
}
